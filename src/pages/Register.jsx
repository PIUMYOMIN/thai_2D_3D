...
export default function Register() {
  ...
  return (
    <div className="w-full h-[80vh] border-2 border-red-600 flex justify-center items-center">
      <div className="my-5">
        <form>
            ...
            <div className="w-full flex flex-col my-2">
              ...
              <div className="w-full relative" ref={dropdownRef}>
                ...
                <input
                  type="tel"
                  id="phone"
                  className="w-60 overflow-hidden bg-white text-black placeholder:text-slate-400 text-sm border border-slate-200 rounded-md pr-3 pl-16 py-2 focus:outline-none"
                  placeholder="324-456-2323"
                  onInput={handlePhoneChange}
                />

                {dropdownOpen &&
                  <div className="absolute left-0 w-full bg-white border border-slate-200 rounded-md shadow-lg z-10">
