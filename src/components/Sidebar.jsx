...
function Sidebar({ isSidebarOpen, closeSidebar }) {
  ...
  return <div className={`absolute bg-dark text-white w-64 h-full p-4 z-10 transition-all duration-300 top-16 rounded-r-lg ${isSidebarOpen ? "left-0" : "left-[-100%]"}`}>
      <div className="relative">
        <div className="flex flex-col gap-2">
          ...
          <Link to="/history" className="flex flex-row items-center py-1 px-4 rounded text-slate-300 hover:bg-gray-800 no-underline" style={cardColor}>
            <FaListOl />
